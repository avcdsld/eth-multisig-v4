...
describe('ForwarderV4', function () {
  ...
  it('Should not init if parent address is invalid address', async function () {
  ...
  describe('NFT Support', function () {
    ...
    before(async function () {
      ...
      noAutoFlushForwarder = await ForwarderV4.new([], {
        from: accounts[1]
      });
    ...
    describe('ERC1155', () => {
      ...
      describe('Flush', () => {
        it('should flush erc1155 tokens back to parent address when caller is feeAddress', async () => {
